...
void PresetBrowser::initFactoryPresets()
{
    ...
    factoryPresets = {
        ...
        { "Slapback Electric Guitar Cab", "Electric Guitar, Amp | Slap, Direct | Discrete boundary reflections for amp-in-room punch", 0, 0.70f, 0.22f, 0.38f, 0.06f, 0.50f, 0.80f, 18.0f, 0.85f, 0.12f, 0.30f, 0.20f, 2, 0.0f, -13.0f, 0.0f, -20.0f, 10.0f, 100.0f, 1, 130.0f, 0.0f, 2, 5500.0f, -2.0f, 0.25f, 15.0f, 0.50f, 0.30f, 4.0f, 0.85f },
        ...
        { "Tape Crushed Slap Chamber", "Creative, Lo-Fi | Saturated, Slap | Heavy tape overdrive combined with vintage slap reflections", 0, 0.60f, 0.40f, 0.35f, 0.28f, 0.75f, 0.75f, 34.0f, 0.85f, 0.45f, 0.35f, 0.20f, 1, 0.0f, -11.0f, 4.0f, -18.0f, 2.0f, 160.0f, 1, 220.0f, 0.0f, 1, 6000.0f, 0.0f, 0.30f, 15.0f, 0.45f, 0.40f, 3.0f, 1.50f },
        { "Micro Concrete Closet", "Creative, FX | Boxy, Resonant | Ultra-cramped concrete booth with sharp metallic boundary nodes", 0, 0.35f, 0.12f, 0.20f, 0.00f, 0.10f, 0.50f, 0.0f, 0.95f, 0.05f, 0.00f, 0.20f, 3, 0.0f, -12.0f, 0.0f, -20.0f, 5.0f, 80.0f, 2, 350.0f, 3.5f, 2, 8500.0f, 2.0f, 0.15f, 10.0f, 0.35f, 0.10f, 6.0f, 0.60f },
        { "Asymmetrical Chaos Room", "Creative, Experimental | Disoriented, Psychoacoustic | Maximum asymmetric boundary diffusion with warping modulation", 0, 1.40f, 0.65f, 0.45f, 0.55f, 1.10f, 1.00f, 25.0f, 0.80f, 0.15f, 0.20f, 0.20f, 2, 0.0f, -12.0f, 6.0f, -20.0f, 1.0f, 220.0f, 1, 75.0f, 0.0f, 2, 10000.0f, 2.5f, 0.85f, 35.0f, 0.80f, 0.95f, -2.0f, 0.85f },
        ...
        { "Snare Punch Live Chamber", "Snare, Claps | Fat, Explosive | Dense early cluster and saturated tube harmonics dialed for maximum rimshot impact and crack", 1, 1.02f, 1.10f, 0.72f, 0.14f, 0.45f, 0.85f, 12.0f, 0.78f, 0.18f, 0.12f, 0.20f, 2, 0.0f, -10.5f, 1.0f, -14.0f, 3.0f, 70.0f, 1, 90.0f, 0.0f, 2, 10000.0f, 0.8f, 0.76f, 22.0f, 0.82f, 0.32f, 2.0f, 0.95f },
        ...
        { "Nonlinear Stone Wall Slam", "Industrial Drums, Hard Hits | Massive, Gated | Aggressive hard-clipped wall slap combining high ER reflection density with hyper-fast envelope cutoff", 1, 1.38f, 1.15f, 0.50f, 0.08f, 0.30f, 0.90f, 14.0f, 0.94f, 0.40f, 0.00f, 0.20f, 3, 0.0f, -8.0f, 9.5f, -16.0f, 0.8f, 110.0f, 1, 50.0f, 0.0f, 1, 9000.0f, 0.0f, 0.80f, 68.0f, 0.90f, 0.20f, 4.5f, 1.60f },
        ...
        { "Neon Dusk 1984", "Synthwave, Electronic | Pumping, Retro, Huge | Massive gated & ducked 80s hall tailored for synth leads, arps, and gated snare", 2, 1.70f, 3.80f, 0.90f, 0.45f, 1.20f, 1.00f, 12.0f, 0.48f, 0.25f, 0.40f, 0.20f, 1, 0.0f, -10.0f, 12.0f, -18.0f, 1.5f, 180.0f, 1, 140.0f, 0.0f, 2, 14000.0f, 2.0f, 0.82f, 35.0f, 0.94f, 0.08f, -2.0f, 0.60f },
        { "Abyssal Infinite Drone", "Ambient, Drone | Endless, Dark, Shimmering | Colossal subterranean hall with dark absorption and eternal slow-evolving tail", 2, 2.00f, 4.50f, 0.98f, 0.60f, 0.12f, 1.00f, 65.0f, 0.20f, 0.68f, 0.10f, 0.20f, 2, 0.0f, -11.0f, 2.0f, -28.0f, 40.0f, 800.0f, 2, 80.0f, 2.5f, 1, 5500.0f, 0.0f, 0.95f, 60.0f, 1.00f, 0.45f, -5.5f, 2.20f },
        ...
        { "Stadium Arena Rock", "Drums, Guitars, Rock | Cavernous, Punchy | Colossal indoor arena with hard wall reflections and thunderous low-end weight", 3, 1.85f, 4.20f, 0.70f, 0.22f, 0.35f, 1.00f, 75.0f, 0.82f, 0.75f, 0.18f, 0.20f, 1, 0.0f, -13.5f, 0.3f, -16.0f, 12.0f, 220.0f, 0, 55.0f, 1.5f, 1, 7500.0f, -3.0f, 0.68f, 30.0f, 0.78f, 0.28f, 0.2f, 0.65f },
        ...
        { "Tight Snare Plate", "Snare, Drums | Punchy, Dense, Crisp | High-density 0.8s damping plate designed to add explosive body and crack", 4, 0.70f, 0.85f, 0.95f, 0.10f, 0.60f, 0.80f, 0.0f, 0.65f, 0.08f, 0.15f, 0.20f, 2, 0.0f, -8.5f, 0.0f, -20.0f, 10.0f, 200.0f, 1, 160.0f, 0.0f, 2, 12000.0f, 1.2f, 0.85f, 15.0f, 0.96f, 0.28f, 1.8f, 0.90f },
        ...
        { "60s Motown Plate", "Vocal, Soul, Snare | Warm, Mid-Forward, Historic | Classic 60s hits style with slap pre-delay and analog tape drive", 4, 0.92f, 2.80f, 0.86f, 0.20f, 0.35f, 0.82f, 55.0f, 0.52f, 0.22f, 0.12f, 0.20f, 1, 0.0f, -9.0f, 2.0f, -20.0f, 10.0f, 240.0f, 1, 130.0f, 0.0f, 1, 9500.0f, 0.0f, 0.72f, 32.0f, 0.88f, 0.45f, -0.5f, 1.20f },
        { "70s Classic Rock Drum Plate", "Drums, Rock, Toms | Massive, Gritty, Explosive | Driven tube plate with punchy dynamics for arena drum overheads", 4, 1.05f, 1.60f, 0.94f, 0.15f, 0.55f, 1.00f, 12.0f, 0.60f, 0.12f, 0.18f, 0.20f, 2, 0.0f, -7.5f, 0.0f, -18.0f, 10.0f, 150.0f, 1, 90.0f, 0.0f, 2, 7000.0f, -1.0f, 0.88f, 20.0f, 0.95f, 0.38f, 0.2f, 1.10f },
        ...
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        { "63 Surf Twin Drip", "Guitar, Surf | Twangy, Boing | Classic 6G15 dual-spring tank with maximum drip, splash, and tube warmth", 5, 0.85f, 2.80f, 0.38f, 0.18f, 0.85f, 0.65f, 12.0f, 0.82f, 0.45f, 0.35f, 0.20f, 2, 0.0f, -8.5f, 0.0f, -24.0f, 20.0f, 150.0f, 0, 140.0f, 0.0f, 1, 5800.0f, 2.5f, 0.85f, 65.0f, 0.42f, 0.30f, 0.8f, 0.20f },
        { "Texas Blues Stage", "Guitar, Blues | Gritty, Woody | Dynamic amp spring tuned for stinging lead guitars and touch sensitivity", 5, 0.70f, 2.10f, 0.52f, 0.12f, 0.60f, 0.50f, 18.0f, 0.65f, 0.55f, 0.48f, 0.20f, 2, 0.0f, -11.0f, 0.1f, -22.0f, 15.0f, 120.0f, 0, 160.0f, 0.0f, 0, 4800.0f, 0.0f, 0.62f, 50.0f, 0.55f, 0.25f, 0.8f, 0.30f },
        { "Kingston Dub Splash", "Drums, Dub | Resonant, Long | High-feedback dub spring with heavy tape drive and resonant high-frequency splash", 5, 1.40f, 5.50f, 0.45f, 0.42f, 0.40f, 0.90f, 35.0f, 0.90f, 0.30f, 0.55f, 0.20f, 1, 0.0f, -4.0f, 0.0f, -20.0f, 10.0f, 200.0f, 0, 180.0f, 0.0f, 2, 3200.0f, 4.5f, 0.92f, 80.0f, 0.48f, 0.45f, 0.7f, 0.20f },
        ...
        { "Suitcase Rhodes Spring", "Keys, EP | Warm, Organic | Melodic coil response preserving bell transients and rounding midrange chords", 5, 0.80f, 2.40f, 0.65f, 0.25f, 0.70f, 0.85f, 10.0f, 0.55f, 0.60f, 0.50f, 0.20f, 0, 0.0f, -11.5f, 0.1f, -20.0f, 15.0f, 180.0f, 0, 150.0f, 0.0f, 0, 6000.0f, 0.0f, 0.50f, 45.0f, 0.68f, 0.20f, 0.8f, 0.25f },
        { "Hammond Tone Coil", "Organ, B3 | Swirling, Mechanical | Internal organ tank resonance designed for percussive key clicks and drawbars", 5, 0.95f, 2.60f, 0.58f, 0.35f, 1.20f, 0.75f, 8.0f, 0.70f, 0.48f, 0.38f, 0.20f, 2, 0.0f, -9.5f, 0.0f, -24.0f, 10.0f, 150.0f, 0, 120.0f, 0.0f, 0, 5200.0f, 0.0f, 0.70f, 60.0f, 0.60f, 0.35f, 0.7f, 0.28f },
        { "Motown Snare Crack", "Snare, 60s | Punchy, Splashy | Short and fat mechanical crack providing explosive body to vintage snare tracks", 5, 0.65f, 1.80f, 0.48f, 0.10f, 0.50f, 0.60f, 15.0f, 0.85f, 0.42f, 0.30f, 0.20f, 1, 0.0f, -8.0f, 0.2f, -18.0f, 8.0f, 80.0f, 0, 180.0f, 0.0f, 2, 4200.0f, 3.5f, 0.80f, 70.0f, 0.50f, 0.28f, 0.8f, 0.20f },
        { "Rockabilly Slap Tank", "Slapback, 50s | Tight, Springy | Short decay slap tank delivering authentic Sun Studio bounce and twang", 5, 0.50f, 1.50f, 0.40f, 0.08f, 0.60f, 0.40f, 65.0f, 0.78f, 0.52f, 0.45f, 0.20f, 1, 0.0f, -10.0f, 0.0f, -20.0f, 10.0f, 100.0f, 0, 160.0f, 0.0f, 0, 5500.0f, 0.0f, 0.75f, 65.0f, 0.45f, 0.20f, 0.9f, 0.25f },
        ...
        { "Overdriven Trash Spring", "FX, Industrial | Crushed, Chaotic | Slammed input springs pushed into hard clipping for aggressive indie textures", 5, 1.10f, 3.60f, 0.35f, 0.55f, 1.80f, 0.95f, 5.0f, 0.95f, 0.25f, 0.20f, 0.20f, 3, 0.0f, -6.0f, 0.3f, -16.0f, 5.0f, 90.0f, 0, 100.0f, 0.0f, 1, 4000.0f, 5.0f, 0.95f, 90.0f, 0.40f, 0.65f, 0.6f, 0.20f },
        { "Alien Helix Resonance", "FX, Sci-Fi | Warped, Dispersive | Extreme dispersion and deep asymmetry creating metallic pitch-bending vortices", 5, 1.50f, 5.80f, 0.25f, 0.85f, 0.35f, 1.00f, 45.0f, 0.75f, 0.18f, 0.15f, 0.20f, 1, 0.0f, -4.5f, 0.0f, -24.0f, 30.0f, 300.0f, 2, 350.0f, 4.0f, 2, 2800.0f, 6.0f, 1.00f, 100.0f, 0.28f, 0.90f, 0.5f, 0.20f },
        { "AM Radio Lo-Fi Tank", "FX, Vintage | Bandpassed, Grungy | Narrow bandpass and spring flutter evoking 1940s broadcast transmission", 5, 0.45f, 2.00f, 0.60f, 0.40f, 2.00f, 0.05f, 15.0f, 0.60f, 0.70f, 0.60f, 0.20f, 0, 0.0f, -8.0f, 0.0f, -20.0f, 15.0f, 120.0f, 0, 450.0f, 0.0f, 0, 3000.0f, 0.0f, 0.60f, 50.0f, 0.55f, 0.10f, 0.7f, 0.50f },
        ...
        { "06 Intimate Jazz Club Ballad", "Jazz, Acoustic | Smoky, Organic | Vintage club intimacy with deep tube warmth and unhurried natural decay", 6, 0.90f, 2.10f, 0.82f, 0.18f, 0.38f, 0.80f, 22.0f, 0.62f, 0.22f, 0.10f, 0.20f, 2, 0.0f, -8.5f, 0.0f, -25.0f, 20.0f, 200.0f, 2, 150.0f, 1.0f, 2, 7500.0f, -2.0f, 0.75f, 16.0f, 0.88f, 0.35f, 0.5f, 1.30f },
        { "07 Snare 70s Gold Hit", "Snare, Drums | Punchy, Dense | Classic 1970s dense plate explosion adding explosive weight and crack to snares", 6, 0.80f, 1.35f, 0.94f, 0.12f, 0.80f, 0.85f, 10.0f, 0.75f, 0.15f, 0.35f, 0.20f, 1, 0.0f, -9.5f, 3.0f, -16.0f, 4.0f, 150.0f, 1, 200.0f, 0.0f, 2, 6000.0f, 2.5f, 0.88f, 14.0f, 0.95f, 0.25f, 3.0f, 1.00f },
        ...
        { "Dark Post-Rock Cavern", "Post-Rock, Shoegaze | Massive, Moody | Deep granite underground decay for atmospheric swell guitars and slow heavy basslines", 7, 1.85f, 45.00f, 0.88f, 0.50f, 0.25f, 1.00f, 60.0f, 0.40f, 0.30f, 0.20f, 0.20f, 0, 0.0f, -8.0f, 4.0f, -22.0f, 10.0f, 350.0f, 1, 75.0f, 0.0f, 2, 5500.0f, -3.0f, 0.82f, 65.0f, 0.85f, 0.78f, -1.5f, 1.50f },
        ...
        { "Modular Drone Architect", "Electronic, Modular | Hypnotic, Deep | Slow-moving pitch modulation and dense multi-tap reflections for evolving Eurorack drones", 7, 1.95f, 80.00f, 0.96f, 0.58f, 0.08f, 1.00f, 40.0f, 0.42f, 0.14f, 0.00f, 0.20f, 2, 0.0f, -6.0f, 0.0f, -20.0f, 10.0f, 200.0f, 2, 120.0f, 1.5f, 1, 14000.0f, 0.0f, 0.92f, 65.0f, 0.94f, 0.82f, -2.5f, 1.05f },
        { "Granite SFX Resonator", "SFX, Game Audio | Industrial, Ominous | Massive granite shockwave resonance for explosions, blast impacts, and mechanical hits", 7, 2.00f, 30.00f, 0.85f, 0.25f, 0.30f, 1.00f, 15.0f, 0.70f, 0.18f, 0.00f, 0.20f, 1, -2.0f, -4.0f, 0.0f, -20.0f, 10.0f, 150.0f, 2, 90.0f, 2.5f, 2, 4500.0f, -3.5f, 0.92f, 85.0f, 0.88f, 0.90f, 1.0f, 1.70f },
