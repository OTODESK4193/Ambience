...
namespace FDNReverb {
    ...
    static constexpr AlgorithmPreset PRESET_ROOM1 = {
        "ROOM1", "Real Room 1 (OpenAIR)", 40.0f,
        {
            ...
            {{ 0.95f, 0.92f, 0.88f, 0.84f, 0.80f, 0.80f, 0.72f, 0.64f, 0.48f, 0.30f }},
    ...
    static constexpr AlgorithmPreset PRESET_ROOM2 = {
        ...
        {
            {{ 1.18f, 1.15f, 1.10f, 1.05f, 1.00f, 1.00f, 0.90f, 0.80f, 0.60f, 0.35f }},
    ...
    static constexpr AlgorithmPreset PRESET_HALL1 = {
        ...
        {
            {{ 2.80f, 2.70f, 2.60f, 2.40f, 2.10f, 2.00f, 1.80f, 1.40f, 0.80f, 0.40f }},
    ...
    static constexpr AlgorithmPreset PRESET_HALL2 = {
        ...
        {
            {{ 3.50f, 3.37f, 3.25f, 3.00f, 2.62f, 2.50f, 2.25f, 1.75f, 1.00f, 0.50f }},
    ...
    static constexpr AlgorithmPreset PRESET_PLATE = {
        ...
        {
            {{ 3.50f, 3.20f, 3.00f, 2.40f, 2.00f, 2.00f, 1.40f, 0.80f, 0.40f, 0.20f }},
    ...
    static constexpr AlgorithmPreset PRESET_SPRING = {
        ...
        {
            {{ 0.50f, 0.70f, 0.90f, 1.20f, 1.50f, 1.50f, 1.05f, 0.60f, 0.15f, 0.05f }},
    ...
    static constexpr AlgorithmPreset PRESET_GOLDFOIL = {
        ...
        {
            {{ 1.80f, 1.70f, 1.65f, 1.575f, 1.50f, 1.50f, 1.35f, 1.20f, 0.15f, 0.05f }},
    ...
    static constexpr AlgorithmPreset PRESET_INCHINDOWN = {
        ...
        {
            // RT60 (s)   31     62     125    250    500     1k     2k     4k     8k    16k
            {{ 130.0f, 120.0f, 111.7f, 70.3f, 43.2f, 28.8f, 17.6f, 7.77f, 2.3f, 1.0f }},
