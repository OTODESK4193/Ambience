...
namespace FDNReverb {
    ...
    static constexpr std::array<PresetDefaults, NUM_ALGORITHMS> PRESET_DEFAULTS = { {
        // Room1: 小型ライブ部屋・アコースティックブース (40 m³)
        { 0.80f, 0.25f, 0.55f, 0.12f, 0.45f, 0.75f,  4.0f, 0.75f, 1.0f, 0.25f, 0.35f, 0.08f, 0,  0.40f, 14.0f, 0.60f, 0.65f, +4.0f, 0.5f },
        // Room2: 中型ライブ部屋・ウッドルーム (150 m³)
        { 1.00f, 1.20f, 0.70f, 0.20f, 0.50f, 0.88f, 12.0f, 0.65f, 1.0f, 0.20f, 0.15f, 0.15f, 1,  0.70f, 25.0f, 0.75f, 0.45f, +2.0f, 0.8f },
        // Hall1: 中型コンサートホール・室内楽ホール (3500 m³)
        { 1.30f, 1.90f, 0.80f, 0.28f, 0.50f, 0.92f, 22.0f, 0.50f, 1.0f, 0.30f, 0.08f, 0.10f, 0,  0.65f, 45.0f, 0.80f, 0.20f, +0.5f, 1.2f },
        // Hall2: 大型シンフォニーホール・大聖堂 (18000 m³)
        { 1.65f, 2.40f, 0.90f, 0.35f, 0.40f, 1.00f, 35.0f, 0.45f, 1.0f, 0.40f, 0.02f, 0.08f, 0,  0.80f, 65.0f, 0.85f, 0.15f, -2.0f, 1.8f },
        // Plate: 金属板 (EMT 140 クラシック・スチールプレート)
        { 0.75f, 1.80f, 0.92f, 0.18f, 0.65f, 0.90f,  0.0f, 0.65f, 1.0f, 0.15f, 0.40f, 0.25f, 2,  0.90f, 15.0f, 0.95f, 0.35f, +1.5f, 0.3f },
        // Spring: スプリングリバーブ (AKG BX20 / Vintage Tank)
        { 0.55f, 2.80f, 0.45f, 0.38f, 0.80f, 0.70f,  0.0f, 0.55f, 1.0f, 0.55f, 0.25f, 0.40f, 3,  0.30f, 12.0f, 0.35f, 0.60f, +2.5f, 0.2f },
        // Goldfoil: 金箔マイクロプレート (EMT 240)
        { 0.90f, 2.10f, 0.88f, 0.20f, 0.55f, 0.92f,  4.0f, 0.60f, 1.0f, 0.35f, 0.20f, 0.25f, 1,  0.80f, 16.0f, 0.92f, 0.40f, +1.0f, 0.4f },
        // Inchindown: 巨大地下燃料タンク (Guinness Record 112s)
        { 2.00f, 35.0f, 0.95f, 0.45f, 0.15f, 1.00f, 65.0f, 0.40f, 1.0f, 0.80f, 0.00f, 0.14f, 0,  0.85f, 80.0f, 0.88f, 0.85f, -4.5f, 2.5f }
    } };
