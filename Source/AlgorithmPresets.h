...
namespace FDNReverb {
    ...
    struct PresetDefaults {
        ...
        float erCrossoverMs;  // [10.0, 100.0]
        float lateDensity;    // [0.1, 1.0]
        float asymmetry;      // [0.0, 1.0]
        float clarityDB;      // [-6.0, +6.0]
        float airAbsorbScale; // [0.2, 2.5]
    };

    static constexpr std::array<PresetDefaults, NUM_ALGORITHMS> PRESET_DEFAULTS = { {
        // Room1: 小型ライブ部屋・アコースティックブース (40 m³) [1kHz RT60 = 0.21s]
        { 0.80f, 0.21f, 0.55f, 0.12f, 0.45f, 0.75f,  4.0f, 0.75f, 1.0f, 0.00f, 0.00f, 0.08f, 0,  0.40f, 14.0f, 0.60f, 0.65f, +4.0f, 1.0f },
        // Room2: 中型ライブ部屋・ウッドルーム (150 m³) [1kHz RT60 = 1.38s]
        { 1.00f, 1.38f, 0.70f, 0.20f, 0.50f, 0.88f, 12.0f, 0.65f, 1.0f, 0.00f, 0.00f, 0.15f, 1,  0.70f, 25.0f, 0.75f, 0.45f, +2.0f, 1.0f },
        // Hall1: 中型コンサートホール・室内楽ホール (3500 m³) [1kHz RT60 = 1.89s]
        { 1.30f, 1.89f, 0.80f, 0.28f, 0.50f, 0.92f, 22.0f, 0.50f, 1.0f, 0.00f, 0.00f, 0.10f, 0,  0.65f, 45.0f, 0.80f, 0.20f, +0.5f, 1.0f },
        // Hall2: 大型シンフォニーホール・大聖堂 (18000 m³) [1kHz RT60 = 2.08s]
        { 1.65f, 2.08f, 0.90f, 0.35f, 0.40f, 1.00f, 35.0f, 0.45f, 1.0f, 0.00f, 0.00f, 0.08f, 0,  0.80f, 65.0f, 0.85f, 0.15f, -2.0f, 1.0f },
        // Plate: 金属板 (EMT 140 クラシック・スチールプレート) [1kHz RT60 = 1.14s]
        { 0.75f, 1.14f, 0.92f, 0.18f, 0.65f, 0.90f,  0.0f, 0.65f, 1.0f, 0.00f, 0.00f, 0.25f, 2,  0.90f, 15.0f, 0.95f, 0.35f, +1.5f, 1.0f },
        // Spring: スプリングリバーブ (AKG BX20 / Vintage Tank) [1kHz RT60 = 2.93s]
        { 0.55f, 2.93f, 0.45f, 0.38f, 0.80f, 0.70f,  0.0f, 0.55f, 1.0f, 0.00f, 0.00f, 0.40f, 3,  0.30f, 12.0f, 0.35f, 0.60f, +2.5f, 1.0f },
        // Goldfoil: 金箔マイクロプレート (EMT 240) [1kHz RT60 = 2.06s]
        { 0.90f, 2.06f, 0.88f, 0.20f, 0.55f, 0.92f,  4.0f, 0.60f, 1.0f, 0.00f, 0.00f, 0.25f, 1,  0.80f, 16.0f, 0.92f, 0.40f, +1.0f, 1.0f },
        // Inchindown: 巨大地下燃料タンク (Guinness Record 112s) [1kHz RT60 = 35.0s]
        { 2.00f, 35.0f, 0.95f, 0.45f, 0.15f, 1.00f, 65.0f, 0.40f, 1.0f, 0.00f, 0.00f, 0.14f, 0,  0.85f, 80.0f, 0.88f, 0.85f, -4.5f, 1.0f }
    } };
    ...
    static constexpr AlgorithmPreset PRESET_ROOM1 = {
        "ROOM1", "Real Room 1 (OpenAIR)", 40.0f,
        {
            ...
            {{ 0.26f, 0.25f, 0.23f, 0.22f, 0.21f, 0.21f, 0.19f, 0.17f, 0.12f, 0.07f }},
    ...
    static constexpr AlgorithmPreset PRESET_ROOM2 = {
        ...
        {
            {{ 1.63f, 1.59f, 1.52f, 1.45f, 1.38f, 1.38f, 1.24f, 1.10f, 0.82f, 0.48f }},
    ...
    static constexpr AlgorithmPreset PRESET_HALL1 = {
        ...
        {
            {{ 2.65f, 2.55f, 2.46f, 2.27f, 1.98f, 1.89f, 1.70f, 1.32f, 0.76f, 0.38f }},
    ...
    static constexpr AlgorithmPreset PRESET_HALL2 = {
        ...
        {
            {{ 2.91f, 2.80f, 2.70f, 2.50f, 2.18f, 2.08f, 1.87f, 1.46f, 0.83f, 0.42f }},
    ...
    static constexpr AlgorithmPreset PRESET_PLATE = {
        ...
        {
            {{ 2.00f, 1.82f, 1.71f, 1.37f, 1.14f, 1.14f, 0.80f, 0.46f, 0.23f, 0.11f }},
    ...
    static constexpr AlgorithmPreset PRESET_SPRING = {
        ...
        {
            {{ 0.98f, 1.37f, 1.76f, 2.34f, 2.93f, 2.93f, 2.05f, 1.17f, 0.29f, 0.10f }},
    ...
    static constexpr AlgorithmPreset PRESET_GOLDFOIL = {
        ...
        {
            {{ 2.47f, 2.33f, 2.27f, 2.16f, 2.06f, 2.06f, 1.85f, 1.65f, 0.21f, 0.07f }},
    ...
    static constexpr AlgorithmPreset PRESET_INCHINDOWN = {
        ...
        {
            // RT60 (s)   31     62     125    250    500     1k     2k     4k     8k    16k
            {{ 158.0f, 145.8f, 135.7f, 85.4f, 52.5f, 35.0f, 21.4f, 9.4f, 2.8f, 1.2f }},
