...
namespace FDNReverb {
    ...
    static constexpr std::array<PresetDefaults, NUM_ALGORITHMS> PRESET_DEFAULTS = { {
        ...
        { 0.75f, 1.14f, 0.92f, 0.18f, 0.65f, 0.90f,  0.0f, 0.65f, 1.0f, 0.00f, 0.00f, 0.20f, 2,  0.90f, 15.0f, 0.95f, 0.35f, +1.5f, 1.0f },
        // Spring: スプリングリバーブ (AKG BX20 / Vintage Tank) [1kHz RT60 = 2.93s]
        { 0.55f, 2.93f, 0.45f, 0.38f, 0.80f, 0.70f,  0.0f, 0.55f, 1.0f, 0.00f, 0.00f, 0.20f, 3,  0.30f, 12.0f, 0.35f, 0.60f, +2.5f, 1.0f },
        // Goldfoil: 金箔マイクロプレート (EMT 240) [1kHz RT60 = 2.06s]
        { 0.90f, 2.06f, 0.88f, 0.20f, 0.55f, 0.92f,  4.0f, 0.60f, 1.0f, 0.00f, 0.00f, 0.20f, 1,  0.80f, 16.0f, 0.92f, 0.40f, +1.0f, 1.0f },
